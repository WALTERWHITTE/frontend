...
import {
  ...
  FileText,
  Send,
  User, Users, ShoppingBag, Package
} from 'lucide-react';
            ...
            <div className="relative">
              ...
              {isDatabaseMenuOpen && (
                ...
                >
                  <div className="py-2">
  {[
   { label: 'Client Details', value: 'clientDetails', icon: <User size={16} className="text-blue-600" /> },
    { label: 'Family', value: 'family', icon: <Users size={16} className="text-green-600" /> },
    { label: 'Client Products', value: 'clientProducts', icon: <ShoppingBag size={16} className="text-purple-600" /> },
    { label: 'Products', value: 'products', icon: <Package size={16} className="text-yellow-600" /> },
